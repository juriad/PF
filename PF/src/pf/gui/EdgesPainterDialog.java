...
public class EdgesPainterDialog extends CardDialog {
	...
	public EdgesPainter getEditVerticesPainter() {
	...
	public EdgesPainter getRunVerticesPainter() {
	...
	public EdgesPainter getShowVerticesPainter() {
	...
	private void fillTable(EdgesPainterImpl vp, JTable t) {
		...
		if (vp == null) {
			...
			vp.setUsedStroke(new BasicStroke(3, BasicStroke.CAP_SQUARE,
					BasicStroke.JOIN_MITER, 10, new float[] { 10f, 10f }, 10));
		}
